...
CHECKPOINT_MODELS=(
    ...
    "https://civitai.com/api/download/models/897489?type=Model&format=SafeTensor&size=full&fp=fp16" # 🎨 🟡STOIQO Afrodite | FLUX, XL (🔝🆕🟡F.1D Alpha) by Unknown
)
...
LORA_MODELS=(
    "https://civitai.com/api/download/models/780667?type=Model&format=SafeTensor" # 🎨 FLUX NSFW unlock (FLUX-v0.2) by Unknown
)
...
CLIP_VISION_MODELS=(
    ...
    "https://huggingface.co/UmeAiRT/ComfyUI-Auto_installer/resolve/main/models/clip_vision/sigclip_vision_patch14_384.safetensors?download=true" # 🤗 sigclip_vision_patch14_384.safetensors
)
...
DIFFUSION_MODELS=(
    "https://huggingface.co/UmeAiRT/ComfyUI-Auto_installer/resolve/main/models/diffusion_models/FLUX/flux1-dev-fp8.safetensors?download=true" # 🤗 flux1-dev-fp8.safetensors
    "https://huggingface.co/UmeAiRT/ComfyUI-Auto_installer/resolve/main/models/diffusion_models/FLUX/flux1-depth-dev-fp8.safetensors?download=true" # 🤗 flux1-depth-dev-fp8.safetensors
    "https://huggingface.co/UmeAiRT/ComfyUI-Auto_installer/resolve/main/models/diffusion_models/FLUX/flux1-canny-dev-fp8.safetensors?download=true" # 🤗 flux1-canny-dev-fp8.safetensors
)

CLIP_MODELS=(
    "https://huggingface.co/UmeAiRT/ComfyUI-Auto_installer/resolve/main/models/clip/t5xxl_fp8_e4m3fn.safetensors?download=true" # 🤗 t5xxl_fp8_e4m3fn.safetensors
    "https://huggingface.co/UmeAiRT/ComfyUI-Auto_installer/resolve/main/models/clip/clip_l.safetensors?download=true" # 🤗 clip_l.safetensors
)

STYLE_MODELS=(
    "https://huggingface.co/UmeAiRT/ComfyUI-Auto_installer/resolve/main/models/style_models/flux1-redux-dev.safetensors?download=true" # 🤗 flux1-redux-dev.safetensors
)

PULID_MODELS=(
    "https://huggingface.co/UmeAiRT/ComfyUI-Auto_installer/resolve/main/models/pulid/pulid_flux_v0.9.0.safetensors?download=true" # 🤗 pulid_flux_v0.9.0.safetensors
)
